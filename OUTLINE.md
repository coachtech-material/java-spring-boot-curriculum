...
- **1-1-4 JShell で Java を動かす**
  - 種類: ハンズオン（任意トラックの入口。Part 1〜4 で唯一のハンズオン種別）
  - 逆リンク: 1-1-2（静的型付け）。以降 Part 1〜2 の各「🏃 手を動かす」枠の参照先
